...
setup(name=PKG_NAME,
      ...
      scripts=['scripts/basemap_plot.py',
               ...
               'scripts/extract_terminus.py',
               'scripts/extract_profiles.py',
               'scripts/flowline_plot.py',
               'scripts/flowline_2d_plot.py',
               'scripts/flowline2d_box_plot.py',
               'scripts/im_plot.py',
               'scripts/plot_timeseries.py',
               'scripts/profile_plot.py',
               'scripts/profile_ts_plot.py',
