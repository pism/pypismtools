...
setup(name=PKG_NAME,
      ...
      scripts=['scripts/basemap-plot.py','scripts/qgis-colorramp.py',
               ...
               'scripts/mapplane-fluxes.py',
               'scripts/mapplane-fluxes.py', 'scripts/extract_profiles.py',
               ...
               'scripts/create_greenland_epsg3413_grid.py', 'scripts/extract_sigma_levels.py', 'scripts/plot_timeseries.py'],
      packages=[PKG_NAME],
