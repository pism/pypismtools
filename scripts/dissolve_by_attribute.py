...
parser.add_argument("-a", "--attribute_field", dest="field", help="Attribute field to group by", default="timestep")
parser.add_argument(
    "-o", "--output_filename", dest="out_file", help="Name of the output shape file", default="dissolved.shp"
)
